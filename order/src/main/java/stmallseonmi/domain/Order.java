...
import stmallseonmi.domain.MailSent;
import stmallseonmi.domain.OrderCancelled;
import stmallseonmi.domain.OrderPlaced;
import stmallseonmi.domain.SatusUpdated;
...
public class Order {
    ...
    public void onPostPersist() {
        ...
        MailSent mailSent = new MailSent(this);
        mailSent.publishAfterCommit();

        SatusUpdated satusUpdated = new SatusUpdated(this);
        satusUpdated.publishAfterCommit();
    }
