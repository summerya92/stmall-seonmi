...
import ProductInventoryManagemetManager from "./components/listers/ProductInventoryManagemetCards"
import ProductInventoryManagemetDetail from "./components/listers/ProductInventoryManagemetDetail"
...
export default new Router({
    ...
    routes: [
            ...
            {
                path: '/products/inventoryManagemets',
                name: 'ProductInventoryManagemetManager',
                component: ProductInventoryManagemetManager
            },
            {
                path: '/products/inventoryManagemets/:id',
                name: 'ProductInventoryManagemetDetail',
                component: ProductInventoryManagemetDetail
            },
